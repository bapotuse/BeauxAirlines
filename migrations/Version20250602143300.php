 ...
 */
final class Version20250602143300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vol ADD date_heure_depart_effective DATETIME NOT NULL, ADD date_heure_arrivee_effective DATETIME NOT NULL, CHANGE avion_id avion_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vol RENAME INDEX fk_pilote_id TO IDX_95C97EBF510AAE9
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE vol DROP date_heure_depart_effective, DROP date_heure_arrivee_effective, CHANGE avion_id avion_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE vol RENAME INDEX idx_95c97ebf510aae9 TO FK_pilote_id
        SQL);
        $this->addSql(<<<'SQL'
