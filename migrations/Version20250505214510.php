...
final class Version20250505214510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE gerer (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, vol_id INT DEFAULT NULL, INDEX IDX_103C68BDFB88E14F (utilisateur_id), INDEX IDX_103C68BD9F2BFB7A (vol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE realiser (id INT AUTO_INCREMENT NOT NULL, vol_id INT DEFAULT NULL, pilote_id INT DEFAULT NULL, INDEX IDX_7BAB8D079F2BFB7A (vol_id), INDEX IDX_7BAB8D07F510AAE9 (pilote_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, numero_de_telephone VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
